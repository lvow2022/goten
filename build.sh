...
if [ ! -d "vad/lib" ]; then
    echo "Warning: vad/lib directory not found, please ensure TEN VAD library files are properly installed"
fi

if [ ! -d "vad/include" ]; then
    echo "Warning: vad/include directory not found, please ensure TEN VAD header files are properly installed"
fi
